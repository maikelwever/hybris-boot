...
$(LOCAL_BUILT_MODULE): $(INSTALLED_KERNEL_TARGET) $(BOOT_RAMDISK) $(MKBOOTIMG)
	...
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(MKBOOTIMG) --ramdisk $(RECOVERY_RAMDISK) $(addprefix --second ,$(INSTALLED_2NDBOOTLOADER_TARGET)) --kernel $(INSTALLED_KERNEL_TARGET) --base $(BOARD_KERNEL_BASE) --pagesize $(BOARD_KERNEL_PAGESIZE) $(BOARD_MKRECOVERYIMG_ARGS) --output $@
